...
CREATE INDEX tag_model_uid ON tag (model_uid);
CREATE INDEX tag_tag_name ON tag (tag_name);
CREATE UNIQUE INDEX tag_unique_model_tag ON tag (model_uid, tag_name);
