...
// Source: github.com/instill-ai/protogen-go/model/controller/v1alpha (interfaces: ControllerPrivateServiceClient)
...
func (m *MockControllerPrivateServiceClient) DeleteResource(arg0 context.Context, arg1 *controllerv1alpha.DeleteResourceRequest, arg2 ...grpc.CallOption) (*controllerv1alpha.DeleteResourceResponse, error) {
	m.ctrl.T.Helper()
	...
	ret0, _ := ret[0].(*controllerv1alpha.DeleteResourceResponse)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockControllerPrivateServiceClient) GetResource(arg0 context.Context, arg1 *controllerv1alpha.GetResourceRequest, arg2 ...grpc.CallOption) (*controllerv1alpha.GetResourceResponse, error) {
	m.ctrl.T.Helper()
	varargs := []interface{}{arg0, arg1}
	for _, a := range arg2 {
		varargs = append(varargs, a)
...
func (m *MockControllerPrivateServiceClient) Liveness(arg0 context.Context, arg1 *controllerv1alpha.LivenessRequest, arg2 ...grpc.CallOption) (*controllerv1alpha.LivenessResponse, error) {
	m.ctrl.T.Helper()
	varargs := []interface{}{arg0, arg1}
	for _, a := range arg2 {
		varargs = append(varargs, a)
	...
	ret0, _ := ret[0].(*controllerv1alpha.LivenessResponse)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockControllerPrivateServiceClient) Readiness(arg0 context.Context, arg1 *controllerv1alpha.ReadinessRequest, arg2 ...grpc.CallOption) (*controllerv1alpha.ReadinessResponse, error) {
	m.ctrl.T.Helper()
	varargs := []interface{}{arg0, arg1}
	for _, a := range arg2 {
		varargs = append(varargs, a)
	...
	ret0, _ := ret[0].(*controllerv1alpha.ReadinessResponse)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockControllerPrivateServiceClient) UpdateResource(arg0 context.Context, arg1 *controllerv1alpha.UpdateResourceRequest, arg2 ...grpc.CallOption) (*controllerv1alpha.UpdateResourceResponse, error) {
	m.ctrl.T.Helper()
	varargs := []interface{}{arg0, arg1}
	for _, a := range arg2 {
		varargs = append(varargs, a)
	...
	ret0, _ := ret[0].(*controllerv1alpha.UpdateResourceResponse)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
