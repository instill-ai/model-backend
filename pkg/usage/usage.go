...
func NewUsage(ctx context.Context, r repository.Repository, u mgmtPB.MgmtPrivateServiceClient, rc *redis.Client, usc usagePB.UsageServiceClient) Usage {
	...
	if resp, err := u.GetUserAdmin(ctx, &mgmtPB.GetUserAdminRequest{Name: constant.DefaultOwnerID}); err == nil {
...
func (u *usage) StartReporter(ctx context.Context) {
	...
	go func() {
		...
		err := usageClient.StartReporter(ctx, u.reporter, usagePB.Session_SERVICE_MODEL, config.Config.Server.Edition, u.version, defaultOwnerUID, u.RetrieveUsageData)
		if err != nil {
...
func (u *usage) TriggerSingleReporter(ctx context.Context) {
	...
	err := usageClient.SingleReporter(ctx, u.reporter, usagePB.Session_SERVICE_MODEL, config.Config.Server.Edition, u.version, defaultOwnerUID, u.RetrieveUsageData())
	if err != nil {
