...
type RayMock struct {
	...
	funcModelInferRequest          func(ctx context.Context, task commonpb.Task, req *modelpb.TriggerNamespaceModelRequest, modelName string, version string) (cp1 *modelpb.CallResponse, err error)
...
func (mmModelInferRequest *mRayMockModelInferRequest) Return(cp1 *modelpb.CallResponse, err error) *RayMock {
	if mmModelInferRequest.mock.funcModelInferRequest != nil {
		mmModelInferRequest.mock.t.Fatalf("RayMock.ModelInferRequest mock is already set by Set")
	}
...
func (mmModelInferRequest *mRayMockModelInferRequest) Set(f func(ctx context.Context, task commonpb.Task, req *modelpb.TriggerNamespaceModelRequest, modelName string, version string) (cp1 *modelpb.CallResponse, err error)) *RayMock {
	if mmModelInferRequest.defaultExpectation != nil {
...
func (e *RayMockModelInferRequestExpectation) Then(cp1 *modelpb.CallResponse, err error) *RayMock {
...
func (mmModelInferRequest *RayMock) ModelInferRequest(ctx context.Context, task commonpb.Task, req *modelpb.TriggerNamespaceModelRequest, modelName string, version string) (cp1 *modelpb.CallResponse, err error) {
