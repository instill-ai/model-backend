...
type Ray interface {
	...
	ModelInferRequest(ctx context.Context, task commonpb.Task, req *modelpb.TriggerUserModelRequest, modelName string, version string) (*rayserver.TriggerResponse, error)
