...
const (
	RayService_ModelReady_FullMethodName    = "/model.ray.v1alpha.RayService/ModelReady"
	RayService_ModelMetadata_FullMethodName = "/model.ray.v1alpha.RayService/ModelMetadata"
	RayService_ModelInfer_FullMethodName    = "/model.ray.v1alpha.RayService/ModelInfer"
)
...
// All implementations should embed UnimplementedRayServiceServer
...
// UnimplementedRayServiceServer should be embedded to have forward compatible implementations.
...
var RayService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "model.ray.v1alpha.RayService",
	...
	Metadata: "model/ray/v1alpha/ray.proto",
}
