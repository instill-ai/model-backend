...
export function DeployUndeployModel() {
  // Model Backend API: load model online
  {
    group("Model Backend API: Deploy and undeploy model by admin", function () {
      ...
      let getModelResp = http.get(`${constant.apiPublicHost}/v1alpha/${constant.namespace}/models/${model_id}`).json()

      check(http.post(`${constant.apiPrivateHost}/v1alpha/admin/models/${getModelResp.model.uid}/deploy`, {}, {
        headers: genHeader(`application/json`),
      }), {
      ...
      check(http.post(`${constant.apiPrivateHost}/v1alpha/admin/models/${getModelResp.model.uid}/undeploy`, {}, {
        headers: genHeader(`application/json`),
      }), {
