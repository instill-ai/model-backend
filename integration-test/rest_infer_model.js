...
export function InferModel() {
  ...
  //     check(http.request("POST", `${constant.apiHost}/v1alpha/models/multipart`, fd.body(), {
  //       headers: genHeader(`multipart/form-data; boundary=${fd.boundary}`),
  //     }), {
  ...
  //     check(http.request("POST", `${constant.apiHost}/v1alpha/models/multipart`, fd_empty.body(), {
  ...
  //         r.status === 201,
  //       "POST /v1alpha/models/multipart task semantic response model.name": (r) =>
  //         r.json().model.name === `models/${model_id}`,
  //       "POST /v1alpha/models/multipart task semantic response model.uid": (r) =>
  //         r.json().model.uid !== undefined,
  //       "POST /v1alpha/models/multipart task semantic response model.id": (r) =>
  //         r.json().model.id === model_id,
  //       "POST /v1alpha/models/multipart task semantic response model.description": (r) =>
  //         r.json().model.description === model_description,
  //       "POST /v1alpha/models/multipart task semantic response model.model_definition": (r) =>
  //         r.json().model.model_definition === model_def_name,
  //       "POST /v1alpha/models/multipart task semantic response model.configuration": (r) =>
  //         r.json().model.configuration !== undefined,
  //       "POST /v1alpha/models/multipart task semantic response model.visibility": (r) =>
  //         r.json().model.visibility === "VISIBILITY_PRIVATE",
  //       "POST /v1alpha/models/multipart task semantic response model.owner": (r) =>
  //         r.json().model.user === 'users/local-user',
  //       "POST /v1alpha/models/multipart task semantic response model.create_time": (r) =>
  //         r.json().model.create_time !== undefined,
  //       "POST /v1alpha/models/multipart task semantic response model.update_time": (r) =>
  //         r.json().model.update_time !== undefined,
  //     });
    ...
    group("Model Backend API: Predict Model with instance segmentation model", function () {
      ...
      check(http.request("POST", `${constant.apiHost}/v1alpha/models/multipart`, fd.body(), {
        ...
        "POST /v1alpha/models/multipart task instance response status": (r) =>
          r.status === 201,
        "POST /v1alpha/models/multipart task instance response model.name": (r) =>
          r.json().model.name === `models/${model_id}`,
        "POST /v1alpha/models/multipart task instance response model.uid": (r) =>
          r.json().model.uid !== undefined,
        "POST /v1alpha/models/multipart task instance response model.id": (r) =>
          r.json().model.id === model_id,
        "POST /v1alpha/models/multipart task instance response model.description": (r) =>
          r.json().model.description === model_description,
        "POST /v1alpha/models/multipart task instance response model.model_definition": (r) =>
          r.json().model.model_definition === model_def_name,
        "POST /v1alpha/models/multipart task instance response model.configuration": (r) =>
          r.json().model.configuration !== undefined,
        "POST /v1alpha/models/multipart task instance response model.visibility": (r) =>
          r.json().model.visibility === "VISIBILITY_PRIVATE",
        "POST /v1alpha/models/multipart task instance response model.owner": (r) =>
          r.json().model.user === 'users/local-user',
        "POST /v1alpha/models/multipart task instance response model.create_time": (r) =>
          r.json().model.create_time !== undefined,
        "POST /v1alpha/models/multipart task instance response model.update_time": (r) =>
          r.json().model.update_time !== undefined,
      });
  ...
  //     // Predict with multiple-part
  //     let fd = new FormData();
  //     fd.append("file", http.file(constant.dog_rgba_img));
